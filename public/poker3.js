...
let bank = document.querySelector(".Start");
let currWager = document.querySelector(".Wager");
...
let pScore = document.querySelector('.winText2');
...
function play_game() {
    ...
    if (wager > start_val) {
        exit = true;
		console.log("Balance is: ", start_val);

        document.querySelector(".New").style.visibility = 'visible';
        winLoss.innerText = "Out of Funds";
        document.querySelector(".winText2").style.visibility = 'hidden';
        document.querySelector(".submit").style.visibility = 'hidden';
        document.querySelector(".new1").style.visibility = 'hidden';
        document.querySelector(".new2").style.visibility = 'hidden';
    ...
    if (start == true && exit == false) {
        ...
        document.querySelector('.wagerText').innerText = 'Current Balance: $';
        document.querySelector('.wagerText').innerText += start_val;
        document.querySelector('.wagerText').style.visibility = 'visible';
        ...
        document.body.addEventListener('keypress', (e) =>{
            if(e.key === 'Enter' && swapC == true) {
                ...
                let swapR = numSwap;
                if(swapR > 0 && swapR < 6 && count < 5 && swapR != used[0] && swapR != used[1] && swapR != used[2] && swapR != used[3] && swapR != used[4]) {
                    if(i > 52) {
                        shuffleDeck(deck);
                        i = i % 52;
                    }
            ...
            if(e.key === 'Enter', e.shiftKey == true && swapC == true) {
                ...
                if (p_val == 0 && c_val == 0) {
                    ...
                    if (check == 1) {
                        ...
                        for (let i = 0; i < 5; i++) {
                            for (let j = 0; j < 5; j++) {
                                ...
                                else if (high_card_p < pHand[j]) { 
                                    high_card_p = pHand[j] % 13;
                                }
                            }
                        }
                        check -= 1;
                    ...
                    if (check == 0) {
                        ...
                        for (let i = 0; i < 5; i++) {
                            for (let j = 0; j < 5; j++) {
                                ...
                                else if (high_card_c < cHand[j]) { 
                                    high_card_c = cHand[j] % 13; 
                                }
                            }
                        }
                    }
                    ...
                    else if (cHand[0] % 13 == 0) {
                        high_card_c = 13;
                    }
                    else {
                        high_card_c = cHand[0] % 13; 
                    }
                    ...
                    else if (pHand[0] % 13 == 0) {
                        high_card_p = 13;
                    }
                    else {
                        high_card_p = pHand[0] % 13; 
                    }
                    ...
                    if (high_card_p > high_card_c) {
						...
						//return 2;
                        start_val += wager;
                        pScore.innerText = "Balance is: $";
                        pScore.innerText += start_val;


                    }
                    if (high_card_p < high_card_c) {
                        console.log(high_card_p);
                        console.log(high_card_c);
                ...
                playB.addEventListener('click', function() {
					...
					if (newG == 1) {
                        ...
                        if(start_val > 0) {
                            winLoss.innerText = "Balance is: $";
                            winLoss.innerText += start_val;
                        }
                        SV.style.visibility = 'hidden';
                        document.querySelector(".winText2").style.visibility = 'hidden';
                        document.querySelector(".submit").style.visibility = 'hidden';
...
function checkKeyPress(e) {
    if (e.keyCode == "13" && st_once == false) {
        ...
        st_once = true;
        console.log(st_once);
		currWager.style.visibility = 'hidden';
        bank.style.visibility = 'visible';
        if (start_val == 0) {
            let StartSel = document.querySelector(".startSub");
			StartSel.addEventListener('click', function() {
				let startV = Number(document.querySelector(".start2").value);
					if (startV > 0 ) {
						start_val = startV; 
						console.log(startV);
                        bank.style.visibility = 'hidden';
                        document.querySelector('.wagerText').style.visibility = 'hidden';
                        currWager.style.visibility = 'visible';
                        if (wager == 0) {
                            w_once = true;
                            let wagSel = document.querySelector(".wagerSub");
                            wagSel.addEventListener('click', function() {
                                let wagerV = Number(document.querySelector(".wager2").value);
                                    if (wagerV > 0 && wagerV <= start_val && w_once == true) {
                                        currWager.style.visibility = 'hidden';
                                        //document.querySelector('.wagerText').innerText = 'Current Balance: $';
                                        //document.querySelector('.wagerText').innerText += start_val;
                                        //document.querySelector('.wagerText').style.visibility = 'visible';
                                        ...
                                        if (start == true && exit == false) {
                                            document.querySelector('.wagerText').style.visibility = 'visible';
                                            document.querySelector('.wagerText').innerText += start_val;
                                            document.querySelector('.wager1').style.visibility = 'visible';
                                            document.querySelector('.wager1').innerText += wager;
                                            ...
                                            document.body.addEventListener('keypress', (e) =>{
                                                ...
                                                if(e.key === 'Enter', e.shiftKey == true && swapC == true) {
                                                    ...
                                                    let c_o_1 = false;
                                                    document.querySelector(".New").style.visibility = 'visible';
                                                    pScore.style.visibility = 'hidden';
                                                    let playB = document.querySelector(".submit"); 
                                                    playB.addEventListener('click', function() {
                                                        let newG = document.querySelector(".new2").value
                                                        if (newG == 2 && c_o_1 == false) {
                                                            //c_o_1 = true;
                                                            if (win == 1) {
                                                                //newG.value('');
                                                                //start_val += wager;
